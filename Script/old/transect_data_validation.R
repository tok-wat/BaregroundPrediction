...
pls_valid_5 <- predict(pls_5, df_transect[,predictors_5], ncomp=2)[,,1]
pls_valid_6 <- predict(pls_6, df_transect[,predictors_6], ncomp=2)[,,1]
pls_valid_7 <- predict(pls_7, df_transect[,predictors_7], ncomp=2)[,,1]
pls_valid_8 <- predict(pls_8, df_transect[,predictors_8], ncomp=2)[,,1]
...
######### comparison #########
# obs vs pred plot
pls_valid_list <- list(pls_valid_1,pls_valid_2, pls_valid_3, pls_valid_4,pls_valid_5,pls_valid_6, pls_valid_7, pls_valid_8) 
